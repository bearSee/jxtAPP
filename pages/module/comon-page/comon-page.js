...
Component({
  ...
  methods: {
    ...
    clickList({ detail }) {
      ...
      const { id, newsId, industryNewsId, recruitmentNewsId } = detail;
      wx.navigateTo({ url: `/pages/messageDetail/messageDetail?type=${type}&id=${id || newsId || industryNewsId || recruitmentNewsId}&skipFrom=${this.properties.pageType}` });
    },
    // 查看消息通知
    viewNotice() {
